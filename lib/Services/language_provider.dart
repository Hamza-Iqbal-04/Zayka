...
class AppStrings {
  static const Map<String, Map<String, String>> _localizedValues = {
    ...
    'en': {
      ...
      'rate_food': 'Rate the Food',
      'rate_driver': 'Rate the Driver',
      'how_was_your_experience': 'How was your experience?',
      'please_rate_both': 'Please rate both the food and the driver',
      'optional_comment': 'Add a comment (optional)...',
      'error_submitting': 'Error submitting rating',
      'submit': 'Submit Feedback',
      'skip': 'Skip for now',
      'reached_you_in_less_than_minute': 'We reached you in < 1 minute!',
      'reached_you_in_minutes': 'We reached you in {minutes} minutes!',
    ...
    'ar': {
      ...
      'rate_food': 'تقييم الطعام',
      'rate_driver': 'تقييم السائق',
      'how_was_your_experience': 'كيف كانت تجربتك؟',
      'please_rate_both': 'يرجى تقييم كل من الطعام والسائق',
      'optional_comment': 'أضف تعليقاً (اختياري)...',
      'error_submitting': 'خطأ في إرسال التقييم',
      'submit': 'إرسال التقييم',
      'skip': 'تخطي الآن',
      'reached_you_in_less_than_minute': 'وصلنا إليك في أقل من دقيقة!',
      'reached_you_in_minutes': 'وصلنا إليك في {minutes} دقائق!',
      'enjoy_your_meal': 'استمتع بوجبتك!',
